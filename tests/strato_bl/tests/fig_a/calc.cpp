...
int main(int ac, char** av)
{
  ...
  string opts_common = 
    "--outfreq=60 --nt=1200 --spinup=600 --nx=76 --nz=76 --relax_th_rv=false";
  set<string> opts_micro({
//    "--micro=blk_1m --outdir=out_blk_1m",
//    "--micro=blk_2m --outdir=out_blk_2m",
    "--adv_serial=false --micro=lgrngn --outdir=out_lgrngn --backend=OpenMP --sd_conc=64 --sstp_cond=1 --sstp_coal=1"  
      " --out_wet=\""
