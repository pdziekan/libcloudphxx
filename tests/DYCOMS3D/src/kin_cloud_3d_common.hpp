...
class kin_cloud_3d_common : public 
  output::hdf5_xdmf<
  ...
  >
{
  ...
  typename ct_params_t::real_t dx, dy, dz; // 0->dx, 1->dy ! TODO
  int spinup; // number of timesteps

  // relaxation stuff
  bool relax_th_rv;
  blitz::Array<typename ct_params_t::real_t, 3> th_eq, rv_eq, th_ref, rhod;
...
//    }
  ...
  { 
    typename ct_params_t::real_t dx = 0, dy=0, dz = 0;
