...
int main(int ac, char** av)
{
  ...
  string opts_common = 
    "--outfreq=600 --nt=21600 --spinup=3600 --nx=128 --ny=128 --nz=300 --relax_th_rv=false"; // DYCOMS: 128x300 ; 600 2160 3600
  set<string> opts_micro({
//    "--micro=blk_1m --outdir=out_blk_1m",
//    "--micro=blk_2m --outdir=out_blk_2m",
    "--adv_serial=false --async=true --micro=lgrngn --outdir="+outdir+" --backend=multi_CUDA --sd_conc=40 --sstp_cond=1 --sstp_coal=1"  
      " --out_wet=\""
