...
*/
  string opts_common = 
    "--outfreq=1 --nt=10 --spinup=50 --nx=32 --ny=32 --nz=75 --dt=1 --relax_th_rv=false"; // DYCOMS: 128x300 ; 600 21600 3600
  set<string> opts_micro({
//    "--micro=blk_1m --outdir=out_blk_1m",
//    "--micro=blk_2m --outdir=out_blk_2m",
    "--adv_serial=false --async=true --micro=lgrngn --outdir=out_lgrngn --backend=serial --sd_conc=16 --sstp_cond=1 --sstp_coal=1"  
      " --out_wet=\""
